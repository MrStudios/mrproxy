...
@PacketInformation(
        ...
        mappings = {
                @PacketMapping(id = 0x58, version = MINECRAFT_1_18_2),
                @PacketMapping(id = 0x5D, version = MINECRAFT_1_19_4),
                @PacketMapping(id = 0x5D, version = MINECRAFT_1_20_1)
        }
)
public class ServerSetSubTitlePacket implements Packet {
