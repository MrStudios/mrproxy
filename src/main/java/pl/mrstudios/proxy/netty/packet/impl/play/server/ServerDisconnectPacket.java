...
@PacketInformation(
        ...
        mappings = {
                @PacketMapping(id = 0x19, version = MINECRAFT_1_16_5),
                @PacketMapping(id = 0x1A, version = MINECRAFT_1_18_2),
                @PacketMapping(id = 0x1A, version = MINECRAFT_1_19_4),
                @PacketMapping(id = 0x1A, version = MINECRAFT_1_20_1)
        }
)
