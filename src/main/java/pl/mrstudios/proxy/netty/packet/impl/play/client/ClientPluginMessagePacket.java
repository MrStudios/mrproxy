...
@PacketInformation(
        ...
        mappings = {
                @PacketMapping(id = 0x0B, version = MINECRAFT_1_16_5),
                @PacketMapping(id = 0x0A, version = MINECRAFT_1_18_2),
                @PacketMapping(id = 0x0D, version = MINECRAFT_1_19_4),
                @PacketMapping(id = 0x0D, version = MINECRAFT_1_20_1)
        }
)
