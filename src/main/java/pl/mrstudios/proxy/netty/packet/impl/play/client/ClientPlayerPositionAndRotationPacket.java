...
@PacketInformation(
        ...
        mappings = {
                @PacketMapping(id = 0x13, version = MINECRAFT_1_16_5),
                @PacketMapping(id = 0x12, version = MINECRAFT_1_18_2),
                @PacketMapping(id = 0x15, version = MINECRAFT_1_19_4),
                @PacketMapping(id = 0x15, version = MINECRAFT_1_20_1)
        }
)
public class ClientPlayerPositionAndRotationPacket implements Packet {
